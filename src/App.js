...
const CheckoutTempalteLazy = lazy(() =>
  import("./templates/CheckoutTemplate/CheckoutTemplate")
);
const ProfileTemplateLazy = lazy(() =>
  import("./templates/ProfileTemplate/ProfileTemplate")
);
const AdminTemplateLazy = lazy(() =>
  import("./templates/AdminTemplate/AdminTemplate")
);
const UserTemplateLazy = lazy(() =>
  import("./templates/UsesTemplate/UserTemplate")
);
    ...
    <Router history={history}>
      ...
      <Suspense fallback={<Lazyload />}>
        <Switch>
          ...
          <AdminTemplateLazy
            exact
            path="/admin/edituser/:account"
            Component={EditUser}
          />
          <AdminTemplateLazy
            exact
            path="/admin/createshowtime/:id"
            Component={CreateShowtime}
          />

          <ProfileTemplateLazy
            exact
            path="/profile/generalprofile/:account"
          ...
          <ProfileTemplateLazy
            exact
            path="/profile/bookinghistory/:account"
            Component={BookingHistory}
          />

          <CheckoutTempalteLazy
            exact
            path="/checkout/:id"
            Component={Checkout}
          />
