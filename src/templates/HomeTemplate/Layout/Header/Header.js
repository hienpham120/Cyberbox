    ...
    <Fragment>
      ...
      >
        <nav className="navbarMobile__inner">
          ...
          <a href="#homeapp" activeClass="nav-active" spy={true}>
            Ứng Dụng
          </a>

          <NavLink to="/profile/generalprofile" activeClassName="nav-active">
            Thông Tin
          </NavLink>
          <NavLink to="/admin/statistic" activeClassName="nav-active">
            Quản Trị
          </NavLink>
