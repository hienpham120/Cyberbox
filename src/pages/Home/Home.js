  ...
  const renderCinemaSystem = () => {
    return (
      <Tabs
        ...
        className="c-multipletabs__wrapper"
      >
            ...
            <TabPane
              ...
              tab={
                <img
                  ...
                  src={singleSystem.logo}
                  alt={singleSystem.tenHeThongRap}
                />
              }
              key={indexTab}
            >
              <Tabs tabPosition={tabPosition}>
                {singleSystem.lstCumRap
                  ?.slice(0, 7)
                  .map((cinema, indexTabPane) => {
                    return (
                      <TabPane
                        tab={
                          <div className="cinema-location">
                            ...
                            <div>
                              <h3>
                                {cinema.tenCumRap.length > 20
                                  ? cinema.tenCumRap.substr(0, 23) + " ..."
                                  : cinema.tenCumRap}
                              </h3>
                              <h4>
                                {cinema.diaChi.length > 20
                                  ? cinema.diaChi.substr(0, 23) + " ..."
                                  : cinema.diaChi}
                              </h4>
      ...
      <div className="news--main">
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Cuối tuần qua, hai tác phẩm “Shang-Chi” và “Free Guy” do Disney
              phát hành lần lượt chiếm giữ vị trí quán quân và á quân trên bảng
              xếp hạng phim ăn khách tại phòng vé Bắc Mỹ.
            </p>
          </div>
        </NavLink>
        <NavLink to="/" className="news-content">
          ...
          <div>
            <h3>
              {" "}
              Nam diễn viên đóng vai Giáo sư cầm đầu nhóm trộm cướp là ai?
            </h3>
            <p>
              Năm 2017, Álvaro Morte vào vai Giáo sư trong TV series “Money
              Heist”. Vai diễn đưa tên tuổi anh đến với khán giả toàn thế giới.
            </p>
          </div>
        </NavLink>
      </div>
      ...
      <div className="news--secondary">
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Vị đạo diễn tài danh lựa chọn Universal Pictures là nơi gửi gắm
              tác phẩm mới. Ông hiện chuẩn bị cho dự án phim về cha đẻ của bom
              nguyên tử.
            </p>
          </div>
        </NavLink>
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Vốn là vai ác nhân trong phần một, nhân vật Norman nay bị đặt lên
              vai thử thách phải trở thành người cha tốt, sau khi con gái nuôi
              của ông bị bắt cóc.
            </p>
          </div>
        </NavLink>
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Độ dài của bản phim “No Time to Die” chiếu rạp mới được nhà phát
              hành công bố. Bộ phim là tác phẩm có thời lượng dài nhất về chàng
              điệp viên hào hoa 007.
            </p>
          </div>
        </NavLink>
      </div>
      ...
      <div className="news--main">
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Sau một tháng phát hành, tổng doanh thu phòng vé của “Jungle
              Cruise” đã vượt 186 triệu USD. Walt Disney chính thức thông qua kế
              hoạch sản xuất hậu truyện bộ phim.
            </p>
          </div>
        </NavLink>
        <NavLink to="/" className="news-content">
          ...
          <div>
            <h3>
              NSX 'Mission: Impossible 7' đòi bồi thường gói bảo hiểm 100 triệu
              USD
            </h3>
            <p>
              Công ty sản xuất "Mission: Impossible 7" kiện công ty bảo hiểm vì
              không chi trả thỏa đáng những thiệt hại do ngừng hoạt động vì
              Covid-19.
            </p>
          </div>
        </NavLink>
      ...
      <div className="news--secondary">
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Phát hành tại thị trường Trung Quốc từ ngày 27/8, bộ phim hành
              động, giả tưởng “Free Guy” liên tiếp dẫn đầu bảng xếp hạng phim ăn
              khách tuần.
            </p>
          </div>
        </NavLink>
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Trong “The Matrix Resurrection”, nhân vật Neo do Keanu Reeves thủ
              vai đang lạc lối giữa thực tế ảo mới. Anh một lần nữa bị đặt trước
        ...
        <NavLink to="/" className="news-content">
          ...
          <div>
            ...
            <p>
              Trong bộ phim tội phạm, giật gân “My Name”, Han So Hee đóng vai cô
              con gái dấn thân vào hành trình trả thù cho cha.
            </p>
          </div>
        </NavLink>
      </div>
  ...
  return (
    <Fragment>
      ...
      <section className="news__btn-readmore">
        <button
          className="c-main-btn icon-play"
          onClick={() => {
            let newReadMore = readMore + 1;
            setReadMore(newReadMore);
          }}
        >
          {readMore < 1 ? "Xem Thêm" : "Thu Gọn"}
        </button>
      </section>
    </Fragment>
  );
    ...
    <section className="home">
      ...
      <section className="l-section">
        <div className="news container2">
          <div className="c-primary__title c-primary__title--center">
            <h3 className="title-active" id="news">
              Tin Tức
            </h3>
          </div>
          <News />
      ...
      <section className="l-section">
        <div className="container2">
          <div className="c-primary__title c-primary__title--center">
            <h3 className="title-active" id="event">
              KHUYẾN MÃI
            </h3>
          </div>
        </div>
      ...
      <section
        className="homeApp"
        style={{ backgroundImage: `url(./images/app/app01.jpg)` }}
        id="homeapp"
      >
